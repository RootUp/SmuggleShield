class HTMLSmugglingBlocker {
  constructor() {
    ...
    this.suspiciousPatterns = [
      ...
      { pattern: /<iframe.*src\s*=\s*['"]data:.*['"]/i, weight: 3 }, // Iframes Detection.
      { pattern: /on\w+\s*=\s*['"]javascript:.*['"]/i, weight: 3 }, // Detects suspicious inline event handlers.
      { pattern: /<script[^>]*src=["'].*\.[jJ][sS]\?[^"']+/i, weight: 2 } // Suspicious Script URLs.
    ];
    this.threshold = 4;
    this.setupListeners();
  }
